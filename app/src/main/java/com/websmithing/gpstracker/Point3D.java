...
public class Point3D {
    ...
    public Point3D multiply(double factor) {
        return new Point3D(getX() * factor, getY() * factor, getZ()
                * factor);
    }
    ...
    public Point3D midpoint(double x, double y, double z) {
        return new Point3D(x + (getX() - x) / 2.0, y + (getY() - y) / 2.0,
                z + (getZ() - z) / 2.0);
    }
    ...
    public Point3D crossProduct(double x, double y, double z) {
        ...
        return new Point3D(ay * z - az * y, az * x - ax * z, ax * y - ay
                * x);
    }
    ...
    public String toString() {
        return "Point3D [x = " + getX() + ", y = " + getY() + ", z = "
                + getZ() + "]";
    }
}